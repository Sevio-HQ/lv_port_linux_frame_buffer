...
lv_obj_set_style_bg_color(ui_Home, lv_color_hex(0xFBFBFB), LV_PART_MAIN | LV_STATE_DEFAULT );
...
lv_obj_set_style_text_color(ui_VPNSTATUS_Label2, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT );
